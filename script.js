        ...
        this.themeCategories = [
            ...
            },
            {
                ...
                themes: [
                    ...
                    { id: 'bearded-light', name: 'Bearded Light', description: 'Clean bright theme with modern design and smooth gradients' },
                    ...
                    { id: 'bearded-solarized-light', name: 'Bearded Solarized Light', description: 'Light Solarized with warm cream background' },
                    ...
                    { id: 'bearded-black-&-amethyst', name: 'Black & Amethyst (VS Code)', description: 'Pure black with amethyst crystal accents - VS Code compatible naming' },
                    { id: 'bearded-black-&-amethyst-soft', name: 'Black & Amethyst Soft (VS Code)', description: 'Softer black with muted amethyst tones - VS Code compatible naming' },
                    { id: 'bearded-black-&-diamond', name: 'Black & Diamond (VS Code)', description: 'Deep black with diamond-like brilliance - VS Code compatible naming' },
                    { id: 'bearded-black-&-diamond-soft', name: 'Black & Diamond Soft (VS Code)', description: 'Gentle black with soft diamond sparkle - VS Code compatible naming' },
                    { id: 'bearded-black-&-emerald', name: 'Black & Emerald (VS Code)', description: 'Pure black with emerald gemstone vibrancy - VS Code compatible naming' },
                    { id: 'bearded-black-&-emerald-soft', name: 'Black & Emerald Soft (VS Code)', description: 'Subtle black with soft emerald glow - VS Code compatible naming' },
                    { id: 'bearded-black-&-gold', name: 'Black & Gold (VS Code)', description: 'Elegant black with luxurious gold accents - VS Code compatible naming' },
                    { id: 'bearded-black-&-gold-soft', name: 'Black & Gold Soft (VS Code)', description: 'Refined black with gentle gold highlights - VS Code compatible naming' },
                    { id: 'bearded-black-&-ruby', name: 'Black & Ruby (VS Code)', description: 'Rich black with ruby gemstone intensity - VS Code compatible naming' },
                    { id: 'bearded-black-&-ruby-soft', name: 'Black & Ruby Soft (VS Code)', description: 'Smooth black with soft ruby warmth - VS Code compatible naming' },
                    // Featured Collection

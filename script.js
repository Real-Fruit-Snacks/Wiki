...
class NotesWiki {
    ...
    analyzeText() {
        ...
        // Hide empty state and show hash and stats sections
        const hashSection = document.getElementById('text-analyzer-hash');
    ...
    updateHashDisplay(hash) {
        const hashElement = document.getElementById('md5-hash');
    ...
    copyHashToClipboard() {
        ...
        const copyButton = document.getElementById('copy-hash-btn');
        
        if (!hash) {
            this.showToast('No hash to copy', 'warning');
            return;
        }
        ...
        navigator.clipboard.writeText(hash).then(() => {
            ...
            this.showToast('MD5 hash copied to clipboard', 'success');
